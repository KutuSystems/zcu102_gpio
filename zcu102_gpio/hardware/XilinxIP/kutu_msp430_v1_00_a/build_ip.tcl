...
set orig_proj_dir "../kutu_msp430_v1_00_a"

# Create project
create_project -force kutu_msp430_v1_00_a ../kutu_msp430_v1_00_a

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects kutu_msp430_v1_00_a]
...
add_files -norecurse sources/kutu_msp430.vhd

set_property library kutu_msp430_v1_00_a [get_files sources/axi4_lite_controller.vhd]
set_property library kutu_msp430_v1_00_a [get_files sources/gpio_control.vhd]
set_property library kutu_msp430_v1_00_a [get_files sources/kutu_msp430.vhd]

# Set 'sources_1' fileset properties
set obj [get_filesets sources_1]
set_property "ip_repo_paths" "../../XilinxIP" $obj
set_property "top" "kutu_msp430" $obj
...
ipx::package_project -root_dir {../kutu_msp430_v1_00_a}
...
ipx::unload_core {kutu.com.au:kutu:kutu_msp430:1.0}

puts "INFO: Project created:kutu_msp430_v1_00_a"
