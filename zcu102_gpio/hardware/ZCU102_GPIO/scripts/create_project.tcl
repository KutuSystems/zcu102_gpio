...
set orig_proj_dir "../ZCU102_GPIO"

# Create project
create_project -force ZCU102_GPIO ../ZCU102_GPIO
...
set_property "top" "top_ZCU102_GPIO" $obj
...
add_files -fileset constrs_1 -norecurse sources/constrs_1/ZCU102_GPIO.xdc
...
puts "INFO: Project created:ZCU102_GPIO"
...
make_wrapper -files [get_files ZCU102_GPIO.srcs/sources_1/bd/system_top/system_top.bd] -top
add_files -norecurse ZCU102_GPIO.srcs/sources_1/bd/system_top/hdl/system_top_wrapper.vhd
...
update_compile_order -fileset sources_1
generate_target all [get_files  ZCU102_GPIO.srcs/sources_1/bd/system_top/system_top.bd]
