...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins kutu_gpio_0/S_AXI_LITE] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net Net [get_bd_ports PMOD_1] [get_bd_pins kutu_gpio_0/gpio]
  connect_bd_net -net Net1 [get_bd_ports msp_nrst] [get_bd_pins kutu_msp430_0/msp_nrst]
  connect_bd_net -net Net2 [get_bd_ports msp_test] [get_bd_pins kutu_msp430_0/msp_test]
  ...
  connect_bd_net -net rst_ps8_0_99M_interconnect_aresetn [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins rst_ps8_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins kutu_gpio_0/S_AXI_LITE_ARESETN] [get_bd_pins kutu_msp430_0/S_AXI_LITE_ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x000400010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs kutu_gpio_0/S_AXI_LITE/reg0] SEG_kutu_gpio_0_reg0
